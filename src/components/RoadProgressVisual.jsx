...
const RoadProgressVisual = ({ form4Data, isVisible = true, onToggleVisibility }) => {
  ...
  const visualData = useMemo(() => {
    ...
    // Use actual treatment start/end, not defaulting to 0
    ...
    if (viewMode === 'smart' && totalProjectLength > 10000) {
      ...
      // Auto-fit or short project - use actual data bounds
      minCh = dataMinCh;
      maxCh = dataMaxCh;
      viewMode = 'auto';
    }
  ...
  const { minCh, maxCh, totalLength, statusCounts, completionStats, visibleTreatments, treatmentTypeStats } = visualData;
            ...
            <div className="text-center">
              ...
              <div className="w-full bg-gray-200 rounded-full h-1 mt-1">
                <div 
                  ...
                  style={{ width: `${(statusCounts.planned / completionStats.total) * 100}%` }}
                />
              </div>
            </div>
            <div className="text-center">
